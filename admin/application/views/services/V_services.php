...
<div class="content__header content__boxed overlapping">
	<div class="content__wrap">
		...
		<h1 class="page-title mb-2">Gestion des services</h1>
		<!-- <p>Ici vous pouvez gerer les differents services de la plateforme.</p> -->
		<!-- <button type="button" id="btn_add" data-bs-toggle="modal" class="btn btn-primary">Ajouter</button> -->

		<?php btn_add_action('LST_SERVICES') ?>
						...
						<tbody>
							<?php foreach ($all_data as $value) : ?>
								<tr>
									...
									<td class="actions">
										<?php btn_edit_action($value->id_services, 'LST_SERVICES'); ?> &nbsp;
										<?php btn_delete_action($value->id_services, 'LST_SERVICES'); ?>
									</td>
								</tr>
							<?php endforeach ?>
						</tbody>
		...
		<div class="modal-dialog modal-xl" style="width:100%">
			<div class="modal-content">
				...
				<div class="modal-header">
					<h4 class="modal-title" id="modal_formLabel">Ajout d'un service</h4>
					<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">X</button>
				</div>
				<div class="modal-body">
				<input type="hidden" id="id_services" name="id_services"/>
                    ...
                    <div class="row g-3">
						...
						<div class="mb-6">
							...
							<input id="fichier" name="fichier" type="file" class="form-control" placeholder="fichier" aria-label="fichier" required>
						</div>

				    </div> 
					<?= section_etat_form("Etat service", "etat"); ?>
				</div>
...
<script type="text/javascript">
        ...
        //$(document).ready(function () {
            ...
            $('#datatable-buttons').managing_ajax({
                id_menu: 'menu_services', 
                id_modal_form: 'modal_form',

                id_form: 'form',
                url_submit: "<?php echo site_url('services/C_services/save')?>",

                title_modal_add: 'Ajouter un service',
                focus_add: 'id_services',

                title_modal_edit: 'Modifier un service',
                focus_edit: 'titre',

                url_edit: "<?php echo site_url('services/C_services/get_record')?>",
                url_delete: "<?php echo site_url('services/C_services/delete')?>",
            });
